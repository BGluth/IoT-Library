...
void _IoTLib_get_sensor_ids_to_init_and_potentially_power_on(const struct IoTLib_MngdArray_SnsrID* activeSensorIDs, struct IoTLib_MngdArray_SnsrID* sensorsIdsToInit);
