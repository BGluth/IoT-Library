...
void _IoTLib_lookup_and_call_void_function_for_sensorID(IoTLib_SensorID sensorID, struct IoTLib_MngdKVArray_SnsrIDDataPtr* voidFunctionBuffer);
void _IoTLib_try_lookup_and_call_void_function_in_MKV_with_sensorIDs(IoTLib_SensorID sensorID, struct IoTLib_MngdKVArray_SnsrIDDataPtr* voidFunctionBuffer);

void _IoTLib_get_sensor_ids_to_init_and_potentially_power_on(const struct IoTLib_MngdArray_SnsrID* activeSensorIDs, struct IoTLib_MngdArray_SnsrID* sensorsIdsToInitAndPowerOn);
